...
export default class extends Mixins(PaneMixin) {
  ...
  showTrade(trade: Trade, marketKey: string, colors: PreparedColorStep[], audios: PreparedAudioStep[], significantAmount: number) {
    ...
    return this.renderRow(trade, marketKey, colorStep, level, significantAmount)
  }

  renderRow(trade: Trade, marketKey: string, colorStep: PreparedColorStep, level: number, significantAmount: number) {
    let timestampClass = ''
